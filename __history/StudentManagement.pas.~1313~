...
var
  I     :Integer;
begin
  DbPath  := 'C:\Users\deniz\OneDrive\Masaüstü\StudentManagement\db.json';
  LoadData(DbPath);
end;
...
// TODO
// load data türkçe karakter sorunu
// Tasarým
// sort
// Ayný dersi tekrar ekleme

// --deðiþim yapýlmadýysa kaydetmeyi sorma
// --None numerik deðil ama update etmeyi deniyor
